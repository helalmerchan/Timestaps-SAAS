...
export async function createCheckoutLink(customer: string) {
  const checkout = await stripe.checkout.sessions.create({
    success_url: `http://localhost:3000/dashboard`, // http://localhost:3000/dashboard&success=true
    cancel_url: `http://localhost:3000/dashboard`, // http://localhost:3000/dashboard&success=false
    customer: customer,
    line_items: [
      {
